...
import 'package:avrai/core/services/predictive_outreach/community_proactive_outreach_service.dart';
import 'package:avrai/core/services/predictive_outreach/group_formation_outreach_service.dart';
import 'package:avrai/core/services/predictive_outreach/event_proactive_outreach_service.dart';
import 'package:avrai/core/services/predictive_outreach/business_proactive_outreach_service.dart';
import 'package:avrai/core/services/predictive_outreach/club_proactive_outreach_service.dart';
import 'package:avrai/core/services/predictive_outreach/expert_proactive_outreach_service.dart';
import 'package:avrai/core/services/predictive_outreach/list_suggestion_outreach_service.dart';
...
Future<void> registerPredictiveOutreachServices(GetIt sl) async {
  ...
  logger.debug('📦 [DI-PredictiveOutreach] Registering predictive outreach services...');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] FutureCompatibilityPredictionService registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] TemporalQuantumCompatibilityService registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] FabricStabilityPredictionService registered');

  sl.registerLazySingleton(() => EvolutionPatternAnalysisService(
        stringService: sl<KnotEvolutionStringService>(),
      ));
  logger.debug('✅ [DI-PredictiveOutreach] EvolutionPatternAnalysisService registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] AI2AIOutreachCommunicationService registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] CommunityProactiveOutreachService registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] GroupFormationOutreachService registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] EventProactiveOutreachService registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] BusinessProactiveOutreachService registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] ClubProactiveOutreachService registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] ExpertProactiveOutreachService registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] ListSuggestionOutreachService registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] BackgroundOutreachScheduler registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] SilentNotificationService registered');
  ...
  logger.debug('✅ [DI-PredictiveOutreach] OutreachPreferencesService registered');

  // Phase 6: Scalability Services
  sl.registerLazySingleton(() => CompatibilityCacheService(
        supabaseService: sl<SupabaseService>(),
      ));
  logger.debug('✅ [DI-PredictiveOutreach] CompatibilityCacheService registered');

  sl.registerLazySingleton(() => PredictiveSignalsCacheService(
        supabaseService: sl<SupabaseService>(),
      ));
  logger.debug('✅ [DI-PredictiveOutreach] PredictiveSignalsCacheService registered');

  sl.registerLazySingleton(() => BatchProcessingOptimizationService(
        batchProcessor: sl<BatchOutreachProcessor>(),
      ));
  logger.debug('✅ [DI-PredictiveOutreach] BatchProcessingOptimizationService registered');

  logger.debug('✅ [DI-PredictiveOutreach] All predictive outreach services registered');
}
