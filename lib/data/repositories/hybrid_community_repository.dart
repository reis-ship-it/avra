    ...
    try {
      ...
      for (final r in remote) {
        ...
        final merged = r.copyWith(
          ...
          memberCount: (r.memberCount > l.memberCount) ? r.memberCount : l.memberCount,
          vibeCentroidDimensions: l.vibeCentroidDimensions ?? r.vibeCentroidDimensions,
          vibeCentroidContributors: (l.vibeCentroidContributors > r.vibeCentroidContributors)
