...
class GroupMatchingController
    implements WorkflowController<GroupMatchingInput, GroupMatchingControllerResult> {
  ...
  @override
  Future<GroupMatchingControllerResult> execute(GroupMatchingInput input) async {
    try {
      developer.log(
      ...
      if (isOffline && _aiLearningService != null) {
        ...
        if (offlineResult != null) {
          ...
          return GroupMatchingControllerResult.failure(
            error: 'Offline matching unavailable. Please connect to the internet.',
