...
class QuantumVibeEngine {
  ...
  Future<QuantumVibeState> _compileDimensionQuantum(
    ...
    switch (dimension) {
      case 'exploration_eagerness':
        insightStates.add(QuantumVibeState.fromClassical(behavioral.explorationTendency));
        weights.add(0.4);
        insightStates.add(QuantumVibeState.fromClassical(personality.personalityStrength));
        weights.add(0.3);
        insightStates.add(QuantumVibeState.fromClassical(temporal.currentEnergyLevel));
        weights.add(0.3);
        break;

      case 'curation_tendency':
        insightStates.add(QuantumVibeState.fromClassical(social.leadershipTendency));
        weights.add(0.5);
        insightStates.add(QuantumVibeState.fromClassical(personality.authenticityLevel));
        weights.add(0.3);
        insightStates.add(QuantumVibeState.fromClassical(behavioral.consistencyScore));
        weights.add(0.2);
        break;
      ...
      case 'location_adventurousness':
        insightStates.add(QuantumVibeState.fromClassical(behavioral.explorationTendency));
        weights.add(0.5);
        insightStates.add(QuantumVibeState.fromClassical(behavioral.spontaneityIndex));
        weights.add(0.3);
        insightStates.add(QuantumVibeState.fromClassical(temporal.currentEnergyLevel));
        weights.add(0.2);
        break;
      ...
      case 'authenticity_preference':
        insightStates.add(QuantumVibeState.fromClassical(personality.authenticityLevel));
        weights.add(0.6);
        insightStates.add(QuantumVibeState.fromClassical(relationship.connectionDepth));
        weights.add(0.4);
        break;

      case 'social_discovery_style':
        insightStates.add(QuantumVibeState.fromClassical(social.socialPreference));
        weights.add(0.5);
        insightStates.add(QuantumVibeState.fromClassical(social.communityEngagement));
        weights.add(0.3);
        insightStates.add(QuantumVibeState.fromClassical(behavioral.socialEngagement));
        weights.add(0.2);
        break;
      ...
      case 'temporal_flexibility':
        insightStates.add(QuantumVibeState.fromClassical(behavioral.spontaneityIndex));
        weights.add(0.5);
        insightStates.add(QuantumVibeState.fromClassical(temporal.timeOfDayInfluence));
        weights.add(0.3);
        insightStates.add(QuantumVibeState.fromClassical(temporal.weekdayInfluence));
        weights.add(0.2);
        break;
      ...
      case 'community_orientation':
        insightStates.add(QuantumVibeState.fromClassical(social.communityEngagement));
        weights.add(0.5);
        insightStates.add(QuantumVibeState.fromClassical(social.collaborationStyle));
        weights.add(0.3);
        insightStates.add(QuantumVibeState.fromClassical(relationship.givingTendency));
        weights.add(0.2);
        break;

      case 'trust_network_reliance':
        insightStates.add(QuantumVibeState.fromClassical(social.trustNetworkStrength));
        weights.add(0.6);
        insightStates.add(QuantumVibeState.fromClassical(relationship.relationshipStability));
        weights.add(0.4);
        break;
      ...
      case 'planning_tendency':
        ...
        insightStates.add(QuantumVibeState.fromClassical(1.0 - behavioral.spontaneityIndex));
        weights.add(0.6);
        insightStates.add(QuantumVibeState.fromClassical(behavioral.consistencyScore));
        weights.add(0.4);
        break;
      ...
      case 'novelty_seeking':
        insightStates.add(QuantumVibeState.fromClassical(behavioral.explorationTendency));
        weights.add(0.5);
        insightStates.add(QuantumVibeState.fromClassical(personality.evolutionMomentum));
        weights.add(0.3);
        insightStates.add(QuantumVibeState.fromClassical(relationship.boundaryFlexibility));
        weights.add(0.2);
        break;

      case 'routine_adherence':
        // Inverse of novelty seeking
        insightStates.add(QuantumVibeState.fromClassical(1.0 - behavioral.explorationTendency));
        weights.add(0.5);
        insightStates.add(QuantumVibeState.fromClassical(behavioral.consistencyScore));
        weights.add(0.5);
        break;
    ...
    if (insightStates.length > 1 && _areAligned(insightStates)) {
      final interferedState = _quantumInterfere(insightStates, normalizedWeights, constructive: true);
  ...
  QuantumVibeState _quantumInterfere(
    ...
    if (totalWeight > 0.0) {
      return QuantumVibeState(realSum / totalWeight, imaginarySum / totalWeight);
    }
  ...
  void _applyEntanglementNetwork(Map<String, QuantumVibeDimension> dimensions) {
    ...
    final explorationDimensions = ['exploration_eagerness', 'location_adventurousness', 'novelty_seeking'];
    _entangleDimensionGroup(dimensions, explorationDimensions, 0.3);

    // Entangle social-related dimensions
    final socialDimensions = ['social_discovery_style', 'community_orientation', 'trust_network_reliance'];
    _entangleDimensionGroup(dimensions, socialDimensions, 0.3);

    // Entangle temporal dimensions
    final temporalDimensions = ['temporal_flexibility', 'spontaneity_level', 'planning_tendency'];
  ...
  Future<double> _applyDecoherence(
    ...
    for (final entry in dimensions.entries) {
      ...
      final decoheredState = _applyDecoherenceToState(dimension.state, decoherenceFactor);
  ...
  QuantumVibeState _applyDecoherenceToState(QuantumVibeState state, double decoherenceFactor) {
  ...
  double _calculateQuantumConfidence(
    ...
    confidence += (social.communityEngagement + social.trustNetworkStrength) / 2.0 * 0.2;
