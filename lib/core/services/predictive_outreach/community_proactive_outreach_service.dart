...
class CommunityProactiveOutreachService {
  ...
  Future<void> processCommunityOutreach({
    ...
    try {
      ...
      final fabric = await _getOrCreateFabricForCommunity(communityId, community.memberIds);
      ...
      final futureStability = await _fabricStabilityService.predictFutureFabricStability(
        groupId: communityId,
      ...
      for (final candidate in candidates) {
        try {
          ...
          // D. Current weave fit
          final currentWeaveFit = await _communityService.calculateUserCommunityWeaveFit(
