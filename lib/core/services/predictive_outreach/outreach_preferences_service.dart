  ...
  Future<OutreachPreferences> getUserPreferences({
    ...
    try {
      ...
      return OutreachPreferences(
        ...
        allowCommunityInvitations: response['allow_community_invitations'] as bool? ?? true,
        allowGroupFormation: response['allow_group_formation'] as bool? ?? true,
        allowEventCalls: response['allow_event_calls'] as bool? ?? true,
        allowBusinessOutreach: response['allow_business_outreach'] as bool? ?? true,
        ...
        allowListSuggestions: response['allow_list_suggestions'] as bool? ?? true,
