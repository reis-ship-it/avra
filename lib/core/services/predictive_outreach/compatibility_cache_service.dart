  ...
  Future<CachedCompatibility?> getCachedCompatibility({
    ...
    try {
      ...
      return CachedCompatibility(
        ...
        quantumCompatibility: (response['quantum_compatibility'] as num?)?.toDouble(),
        locationCompatibility: (response['location_compatibility'] as num?)?.toDouble(),
        timingCompatibility: (response['timing_compatibility'] as num?)?.toDouble(),
