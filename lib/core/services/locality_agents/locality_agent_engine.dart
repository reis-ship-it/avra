...
class LocalityAgentEngineV1 {
  ...
  Future<List<double>> inferVector12({
    ...
    final parentState = parentKey != null ? await _globalRepo.getGlobalState(parentKey) : null;
  ...
  List<double> _visitToDeltaSignal({
    ...
    final dwellMin = visit.dwellTime?.inMinutes ?? visit.calculateDwellTime().inMinutes;
    ...
    out[idx('exploration_eagerness')] += (visit.isRepeatVisit ? 0.02 : 0.05) * strength / 0.15;
