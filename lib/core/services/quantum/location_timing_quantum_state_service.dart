...
class LocationTimingQuantumStateService {
  ...
  /// Convert UnifiedLocation to EntityLocationQuantumState
  ///
  /// **Formula:**
  /// |ψ_location(t_atomic)⟩ = [
  ...
  ///
  /// **Parameters:**
  /// - `location`: Physical location (UnifiedLocation)
  ...
  Future<EntityLocationQuantumState> createLocationQuantumState({
    required UnifiedLocation location,
    double? locationType,
...
class LocationCompatibilityCalculator {
  ...
  static double calculateDistanceBasedCompatibility(
    UnifiedLocation locationA,
    UnifiedLocation locationB, {
