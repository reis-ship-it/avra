...
class OutcomePredictionService {
  ...
  Future<List<double>> _prepareHistoryFeatures({String? userId}) async {
    ...
    try {
      ...
      // Calculate rates
      final totalOutcomes = positiveOutcomes + negativeOutcomes + neutralOutcomes;
      final pastPositiveRate = totalOutcomes > 0
          ? positiveOutcomes / totalOutcomes
          : 0.5;
      final pastNegativeRate = totalOutcomes > 0
          ? negativeOutcomes / totalOutcomes
          : 0.5;
      ...
      final normalizedInteractionCount = (interactionCount / 100.0).clamp(0.0, 1.0);
