...
class ModelVersionManager {
  ...
  Future<bool> switchCallingScoreVersion(String newVersion) async {
    if (!ModelVersionRegistry.hasVersion(newVersion, modelType: 'calling_score')) {
      developer.log(
    ...
    final success = ModelVersionRegistry.setActiveCallingScoreVersion(newVersion);
  ...
  Future<double> getVersionWeight(
    ...
    double weight = ModelVersionRegistry.getVersionWeight(version, modelType: modelType);
  ...
  double? getABTestTraffic(String version, {String modelType = 'calling_score'}) {
    final versionInfo = modelType == 'calling_score'
        ? ModelVersionRegistry.getCallingScoreVersion(version)
        : ModelVersionRegistry.getOutcomeVersion(version);
