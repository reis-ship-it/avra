...
class BusinessBusinessMessage extends Equatable {
  ...
  final BusinessBusinessMessageType type; // text, event_partnership_proposal, file
  final bool isRead;
  ...
  const BusinessBusinessMessage({
    ...
    this.encryptionType = EncryptionType.aes256gcm,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'content': content,
      'encrypted_content': encryptedContent != null ? base64Encode(encryptedContent!) : null,
