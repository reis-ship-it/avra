...
class _ProofRunPageState extends State<ProofRunPage> {
  ...
  Future<void> _startRun() async {
    ...
    try {
      ...
      developer.log('Start run failed', name: _logName, error: e, stackTrace: st);
      if (!mounted) return;
  ...
  Future<void> _markMilestone(String eventType,
    ...
    try {
      ...
      developer.log('Milestone failed', name: _logName, error: e, stackTrace: st);
      if (!mounted) return;
      setState(() => _error = e.toString());
    }
  }
  ...
  Future<void> _finishRun() async {
    ...
    try {
      ...
      developer.log('Finish run failed', name: _logName, error: e, stackTrace: st);
      if (!mounted) return;
      setState(() => _error = e.toString());
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Proof Run (debug)'),
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildCard(
            ...
            body:
                'These create ledger receipts tied to the active run_id.\n\n'
          ...
          _buildCard(
            ...
            body: [
              ...
              if (_lastChatResponse != null) 'Last response: $_lastChatResponse',
            ].join('\n'),
            trailing: Column(
          ...
          _buildCard(
            ...
            trailing: ElevatedButton(
              ...
              child: Text(_isSimulatingAi2Ai ? 'Simulating…' : 'Simulate encounter'),
            ),
          ),
          const SizedBox(height: 12),
          _buildCard(
