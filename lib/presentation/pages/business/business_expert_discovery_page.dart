...
import 'package:spots/presentation/pages/business/business_expert_chat_page.dart';
...
class BusinessExpertDiscoveryPage extends StatefulWidget {
  ...
  @override
  State<BusinessExpertDiscoveryPage> createState() => _BusinessExpertDiscoveryPageState();
}

class _BusinessExpertDiscoveryPageState extends State<BusinessExpertDiscoveryPage> {
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Message',
                hintText: 'Introduce yourself and explain why you\'d like to connect...',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Discover Experts'),
                  ...
                  if (expert.compatibilityScore != null)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _getCompatibilityColor(expert.compatibilityScore!)
