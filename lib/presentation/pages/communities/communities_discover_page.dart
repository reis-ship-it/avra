...
class _CommunitiesDiscoverPageState extends State<CommunitiesDiscoverPage> {
  final CommunityService _communityService = GetIt.instance.isRegistered<CommunityService>()
                    ...
                    : _communities.isEmpty
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return _buildCommunityCard(community, authState.user.id);
                            },
                          ),
      ),
    );
  ...
  Future<void> _joinCommunity(Community community, String userId) async {
    ...
    try {
      ...
      setState(() {
        _communities =
            _communities.where((c) => c.id != community.id).toList();
        _breakdownsByCommunityId = Map<String, CommunityTrueCompatibilityBreakdown>.from(
