...
import 'package:spots/presentation/widgets/chat/typing_indicator.dart';
...
class _FriendChatViewState extends State<FriendChatView> {
  ...
  Future<void> _loadUser() async {
    ...
    if (authState is Authenticated) {
      ...
      final displayName = await _nameResolver.getUserDisplayName(widget.friendId);
  ...
  List<Map<String, dynamic>> _applySearchFilter(List<Map<String, dynamic>> messages) {
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (_isTyping && index == _filteredMessages.length) {
                          return TypingIndicator(
                            senderName: _friendDisplayName ?? widget.friendName,
                          );
                        }
