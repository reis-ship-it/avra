...
import 'package:avrai/core/models/unified_user.dart' hide UserRole;
...
import 'package:avrai/core/models/user.dart' show User, UserRole;
  ...
  group('Navigation Flow Integration Tests', () {
    ...
    group('User → Partnership → Payment → Success Flow', () {
      ...
      testWidgets('should navigate from partnership checkout to payment', (WidgetTester tester) async {
        ...
        expect(find.text('Checkout'), findsOneWidget); // PartnershipCheckoutPage displays "Checkout" in AppBar
