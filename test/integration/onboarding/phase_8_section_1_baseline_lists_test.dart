...
void main() {
  ...
  group('Phase 8 Section 1: Baseline Lists Integration', () {
    testWidgets('baselineLists step appears in onboarding flow after preferences', (WidgetTester tester) async {
      // Arrange - Launch app
    ...
    testWidgets('baselineLists step appears before socialMedia step', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(const SpotsApp());
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 100));
    ...
    testWidgets('baseline lists persist when user creates them', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(const SpotsApp());
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 100));
      ...
      final baselineListsPage = tester.widget<BaselineListsPage>(find.byType(BaselineListsPage));
    ...
    testWidgets('social media connection state persists correctly', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(const SpotsApp());
      await tester.pump();
      // ignore: avoid_print
