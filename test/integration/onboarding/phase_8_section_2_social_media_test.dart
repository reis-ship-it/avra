...
void main() {
  ...
  group('Phase 8 Section 2: Social Media Data Collection Integration', () {
    testWidgets('SocialMediaConnectionService is registered and accessible', (WidgetTester tester) async {
      // Arrange & Act
    ...
    testWidgets('can create and store social media connection', (WidgetTester tester) async {
      // Arrange
      final service = di.sl<SocialMediaConnectionService>();
    ...
    testWidgets('can disconnect platform and remove from active connections', (WidgetTester tester) async {
      // Arrange
      final service = di.sl<SocialMediaConnectionService>();
      final agentIdService = di.sl<AgentIdService>();
    ...
    testWidgets('connections use agentId for privacy (not userId)', (WidgetTester tester) async {
      // Arrange
      final service = di.sl<SocialMediaConnectionService>();
      final agentIdService = di.sl<AgentIdService>();
    ...
    testWidgets('can fetch profile data from connection', (WidgetTester tester) async {
      // Arrange
      final service = di.sl<SocialMediaConnectionService>();
      final agentIdService = di.sl<AgentIdService>();
    ...
    testWidgets('AILoadingPage can collect social media data from service', (WidgetTester tester) async {
      // Arrange
      final service = di.sl<SocialMediaConnectionService>();
      final agentIdService = di.sl<AgentIdService>();
    ...
    testWidgets('SocialMediaConnectionPage uses service for connections', (WidgetTester tester) async {
      // Arrange
      ...
      final socialMediaPage = tester.widget<SocialMediaConnectionPage>(find.byType(SocialMediaConnectionPage));
