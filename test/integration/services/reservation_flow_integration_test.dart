  ...
  group('Reservation Flow Integration Tests', () {
    ...
    group('Complete Reservation Workflow', () {
      test('should create reservation, store locally, and retrieve successfully', () async {
        ...
        when(() => mockVibeAnalyzer.compileUserVibe(userId, personalityProfile))
            .thenAnswer((_) async => UserVibe.fromPersonalityProfile(userId, personalityDimensions));
        ...
        final reservations = await reservationService.getUserReservations(userId: userId);
    ...
    group('Reservation Filtering', () {
      test('should filter reservations by status', () async {
        ...
        final pendingReservations = await reservationService.getUserReservations(
          userId: userId,
          status: ReservationStatus.pending,
        );

        final cancelledReservations = await reservationService.getUserReservations(
          userId: userId,
