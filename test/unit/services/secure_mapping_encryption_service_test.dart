...
void main() {
  group('SecureMappingEncryptionService', () {
    ...
    test('should generate different encrypted blobs for same input (IV randomness)', () async {
      // Arrange
      const userId = 'user-123';
      const agentId = 'agent_abc123def456ghi789jkl012mno345pqr678';
    ...
    test('should throw SecurityException when user_id mismatch', () async {
      ...
      final service2 = SecureMappingEncryptionService(secureStorage: mockStorage2);

      // Generate a key for userId2 (different from userId1)
      await service2.encryptMapping(userId: userId2, agentId: 'different_agent');
    ...
    test('should rotate encryption key correctly', () async {
      ...
      expect(newEncrypted.encryptedBlob, isNot(equals(oldEncrypted.encryptedBlob)));
      expect(newEncrypted.encryptionKeyId, isNot(equals(oldEncrypted.encryptionKeyId)));
