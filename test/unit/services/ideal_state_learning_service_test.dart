...
void main() {
  group('IdealStateLearningService', () {
    ...
    group('getIdealState', () {
      test('should return heuristic ideal state when no historical data', () async {
        // Arrange
    ...
    group('learnFromSuccessfulMatch', () {
      test('should learn from successful match and update ideal state', () async {
        // Arrange
        final tAtomic = AtomicTimestamp.now(
          precision: TimePrecision.millisecond,
        );
    ...
    group('calculateIdealStateFromHistory', () {
      ...
      test('should return heuristic state when no historical matches', () async {
        // Arrange
        final tAtomic = AtomicTimestamp.now(
          precision: TimePrecision.millisecond,
        );
