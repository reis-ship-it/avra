...
void main() {
  group('GooglePlacesCacheService Tests', () {
    ...
    setUp(() async {
      ...
      final placesStore =
          sembast.StoreRef<String, Map<String, dynamic>>('google_places_cache');
      final records = await placesStore.find(db, finder: sembast.Finder());
      for (final record in records) {
        await placesStore.record(record.key).delete(db);
      }
    });
