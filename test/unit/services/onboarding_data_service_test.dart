...
void main() {
  group('OnboardingDataService Tests', () {
    ...
    group('Save Onboarding Data', () {
      test('should save onboarding data and convert userId to agentId', () async {
        // Arrange
      ...
      test('should throw exception when saving invalid onboarding data', () async {
        // Arrange
    ...
    group('Get Onboarding Data', () {
      test('should retrieve saved onboarding data correctly', () async {
        ...
        expect(retrieved!.agentId, equals(testAgentId));
        expect(retrieved.age, equals(28));
        verify(() => mockAgentIdService.getUserAgentId(testUserId)).called(2); // Once for save, once for get
      });
    ...
    group('Delete Onboarding Data', () {
      test('should delete saved onboarding data', () async {
        ...
        verify(() => mockAgentIdService.getUserAgentId(testUserId)).called(greaterThanOrEqualTo(3));
      });
      ...
      test('should convert userId to agentId when deleting data', () async {
        ...
        // Assert
        verify(() => mockAgentIdService.getUserAgentId(testUserId)).called(2); // Save, delete
      });
    });
    ...
    group('Privacy Protection - AgentId Conversion', () {
      test('should always use agentId for storage regardless of input agentId', () async {
        ...
        final retrieved = await service.getOnboardingData(testUserId);
        expect(retrieved, isNotNull);
        expect(retrieved!.agentId, equals(differentAgentId)); // Should use converted agentId
      });
    ...
    group('Multiple Users', () {
      test('should store and retrieve data for multiple users independently', () async {
        // Arrange
