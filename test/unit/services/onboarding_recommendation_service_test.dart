...
void main() {
  group('OnboardingRecommendationService Tests', () {
    ...
    group('Get Recommended Lists', () {
      test('should return list of recommendations with compatibility scores', () async {
        // Arrange
      ...
      test('should limit recommendations to maxRecommendations parameter', () async {
        // Arrange
        final onboardingData = {
          'preferences': {'Food & Drink': ['Coffee']},
          'homebase': 'San Francisco, CA',
        };
        final personalityDimensions = <String, double>{'exploration_eagerness': 0.7};
    ...
    group('Get Recommended Accounts', () {
      test('should return list of account recommendations with compatibility scores', () async {
        // Arrange
        final onboardingData = <String, dynamic>{
          'preferences': {
      ...
      test('should limit account recommendations to maxRecommendations parameter', () async {
        // Arrange
        final onboardingData = {'preferences': {}};
    ...
    group('Calculate Compatibility', () {
      test('should calculate compatibility score between user and list dimensions', () {
        // Arrange
        ...
        expect(score, greaterThan(0.5)); // Should be high for similar dimensions
      });

      test('should return low compatibility score for very different dimensions', () {
        // Arrange
        final userDimensions = <String, double>{
      ...
      test('should only consider matching dimensions in compatibility calculation', () {
        // Arrange
        final userDimensions = <String, double>{
          'exploration_eagerness': 0.7,
          'curation_tendency': 0.6,
        ...
        final listDimensions = <String, double>{
          ...
          'location_adventurousness': 0.8, // Different dimension, should be ignored
        };
