...
void main() {
  ...
  group('AgentIdService - Encrypted Storage', () {
    ...
    test('should use encrypted storage when encryption service is available', () async {
      // Arrange
    ...
    test('should work without encryption service (backward compatibility)', () async {
      // Arrange
      const userId = 'user-123';
    ...
    test('should encrypt new mappings when encryption service available', () async {
      // Arrange
      const userId = 'user-123';
