...
void main() {
  group('AIMasterOrchestrator', () {
    ...
    group('Legacy API', () {
      ...
      test('analyzeCollaborationPatterns should complete without error', () async {
        await expectLater(
      ...
      test('generateRecommendations should return empty list', () async {
        ...
        final recommendations = await orchestrator.generateRecommendations(user);
      ...
      test('updatePersonalityProfile should accept Map<String, dynamic>', () async {
        final profileMap = {
          'userId': 'test-user',
