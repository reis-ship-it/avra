...
void main() {
  group('SponsorshipCheckoutController', () {
    ...
    group('validate', () {
      ...
      test('should return invalid result for financial sponsorship without amount', () {
        final input = SponsorshipCheckoutInput(
          event: testEvent,
          brandId: 'brand_456',
          type: SponsorshipType.financial,
      ...
      test('should return invalid result for hybrid sponsorship missing both values', () {
        final input = SponsorshipCheckoutInput(
          event: testEvent,
          brandId: 'brand_456',
          type: SponsorshipType.hybrid,
      ...
      test('should return invalid result when existing sponsorship event ID does not match', () {
        final invalidSponsorship = testFinancialSponsorship.copyWith(eventId: 'different_event');
        final input = SponsorshipCheckoutInput(
          event: testEvent,
          brandId: 'brand_456',
          type: SponsorshipType.financial,
    ...
    group('processSponsorshipCheckout', () {
      test('should successfully process checkout for financial sponsorship', () async {
      ...
      test('should successfully process checkout for product sponsorship with product tracking', () async {
        when(mockEventService.getEventById('event_123'))
            .thenAnswer((_) async => testEvent);
        when(mockSponsorshipService.createSponsorship(
          eventId: 'event_123',
      ...
      test('should successfully process checkout for hybrid sponsorship', () async {
        when(mockEventService.getEventById('event_123'))
            .thenAnswer((_) async => testEvent);
        when(mockSponsorshipService.createSponsorship(
          eventId: 'event_123',
      ...
      test('should return failure for financial sponsorship without user', () async {
        when(mockEventService.getEventById('event_123'))
            .thenAnswer((_) async => testEvent);
        when(mockSponsorshipService.createSponsorship(
          eventId: 'event_123',
