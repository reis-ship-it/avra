  ...
  group('EventCancellationController', () {
    ...
    group('cancelEvent', () {
      ...
      test('should successfully cancel host event and update status', () async {
        ...
        when(mockEventService.updateEventStatus(testEvent, EventStatus.cancelled))
        ...
        verify(mockEventService.updateEventStatus(testEvent, EventStatus.cancelled))
            .called(1);
      });
    ...
    group('calculateRefund', () {
      ...
      test('should calculate full refund for cancellation >48 hours before', () async {
        // Arrange
        ...
        when(mockEventService.getEventById('event_123'))
            .thenAnswer((_) async => testEvent);
        when(mockPaymentService.getPaymentForEventAndUser('event_123', 'user_456'))
            .thenReturn(payment);
      ...
      test('should calculate 50% refund for cancellation 24-48 hours before', () async {
        // Arrange
      ...
      test('should calculate no refund for cancellation <24 hours before', () async {
        // Arrange
    ...
    group('rollback', () {
      test('should restore event status on rollback for full cancellation', () async {
        // Arrange
        final testEvent = ExpertiseEvent(
          id: 'event_123',
          title: 'Test Event',
        ...
        when(mockEventService.getEventById('event_123'))
            .thenAnswer((_) async => testEvent);
        when(mockEventService.updateEventStatus(testEvent, EventStatus.upcoming))
            .thenAnswer((_) async => Future.value());
        ...
        // Assert
        verify(mockEventService.getEventById('event_123')).called(1);
        verify(mockEventService.updateEventStatus(testEvent, EventStatus.upcoming))
            .called(1);
      });
