...
void main() {
  group('QuantumPredictionFeatures', () {
    ...
    test('should serialize and deserialize correctly (round-trip)', () {
      ...
      expect(restored.decoherenceRate,
          closeTo(original.decoherenceRate, 0.001));
      ...
      expect(restored.preferenceDrift, closeTo(original.preferenceDrift, 0.001));
      expect(restored.coherenceLevel,
          closeTo(original.coherenceLevel, 0.001));
    });
  });
}
