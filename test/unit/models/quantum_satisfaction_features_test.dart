...
void main() {
  group('QuantumSatisfactionFeatures', () {
    ...
    test('should serialize and deserialize correctly (round-trip)', () {
      ...
      expect(restored.preferenceAlignment, equals(original.preferenceAlignment));
      ...
      expect(restored.entanglementCompatibility, equals(original.entanglementCompatibility));
      expect(restored.interferenceEffect, equals(original.interferenceEffect));
      expect(restored.decoherenceOptimization, equals(original.decoherenceOptimization));
      expect(restored.phaseAlignment, equals(original.phaseAlignment));
      expect(restored.locationQuantumMatch, equals(original.locationQuantumMatch));
