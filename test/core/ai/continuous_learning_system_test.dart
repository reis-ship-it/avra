...
void main() {
  group('ContinuousLearningSystem - Learning History Persistence', () {
    ...
    test('getLearningHistory returns empty list when Supabase is null', () async {
    ...
    test('getLearningHistory returns empty list when dimension is specified but Supabase is null', () async {
      final history = await learningSystem.getLearningHistory(
        userId: 'test-user-id',
  ...
  group('LearningEvent Model', () {
    ...
    test('handles different data sources', () {
      final sources = ['user_actions', 'location_data', 'weather_data', 'social_data'];
