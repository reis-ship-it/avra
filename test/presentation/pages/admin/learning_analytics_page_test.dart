...
void main() {
  group('LearningAnalyticsPage', () {
    ...
    testWidgets('displays learning analytics title', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: LearningAnalyticsPage(),
        ),
    ...
    testWidgets('displays empty state when no learning data', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: LearningAnalyticsPage(),
        ),
