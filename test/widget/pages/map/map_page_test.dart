...
void main() {
  group('MapPage Widget Tests', () {
    ...
    setUp(() {
      ...
      getSpotsFromRespectedListsUseCase = GetSpotsFromRespectedListsUseCase(fakeSpotsRepository);
...
class _FakeListsBloc extends Bloc<ListsEvent, ListsState> implements ListsBloc {
  ...
  })  : updateListUseCase = updateListUseCase ?? _FakeUpdateListUseCase(listsRepository: null),
        deleteListUseCase = deleteListUseCase ?? _FakeDeleteListUseCase(listsRepository: null),
        super(ListsInitial()) {
