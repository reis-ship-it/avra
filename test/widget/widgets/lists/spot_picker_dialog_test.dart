...
void main() {
  group('SpotPickerDialog Widget Tests', () {
    ...
    testWidgets('should display dialog with list title and initial UI elements', (WidgetTester tester) async {
      ...
      final testSpots = [
        WidgetTestHelpers.createTestSpot(id: 'spot-1', name: 'Coffee Shop', category: 'Cafe'),
        WidgetTestHelpers.createTestSpot(id: 'spot-2', name: 'Restaurant', category: 'Food'),
      ];
    ...
    testWidgets('should filter spots by search query', (WidgetTester tester) async {
      // Arrange: Create spots with different names
      final testSpots = [
        WidgetTestHelpers.createTestSpot(id: 'spot-1', name: 'Coffee Shop', category: 'Cafe'),
        WidgetTestHelpers.createTestSpot(id: 'spot-2', name: 'Pizza Place', category: 'Food'),
        WidgetTestHelpers.createTestSpot(id: 'spot-3', name: 'Tea House', category: 'Cafe'),
      ];
    ...
    testWidgets('should exclude spots from excludedSpotIds', (WidgetTester tester) async {
    ...
    testWidgets('should exclude spots already in list', (WidgetTester tester) async {
    ...
    testWidgets('should toggle spot selection and update selected count', (WidgetTester tester) async {
      // Arrange: Create spots
      final testSpots = [
        WidgetTestHelpers.createTestSpot(id: 'spot-1', name: 'Coffee Shop', category: 'Cafe'),
        WidgetTestHelpers.createTestSpot(id: 'spot-2', name: 'Pizza Place', category: 'Food'),
    ...
    testWidgets('should dismiss dialog when cancel button is tapped', (WidgetTester tester) async {
      // Arrange
      final testSpots = [
        WidgetTestHelpers.createTestSpot(id: 'spot-1', name: 'Coffee Shop', category: 'Cafe'),
      ];
    ...
    testWidgets('should dismiss dialog when close button is tapped', (WidgetTester tester) async {
      // Arrange
      final testSpots = [
        WidgetTestHelpers.createTestSpot(id: 'spot-1', name: 'Coffee Shop', category: 'Cafe'),
      ];
    ...
    testWidgets('should return selected spots when add button is tapped', (WidgetTester tester) async {
      // Arrange
      final testSpots = [
        WidgetTestHelpers.createTestSpot(id: 'spot-1', name: 'Coffee Shop', category: 'Cafe'),
        WidgetTestHelpers.createTestSpot(id: 'spot-2', name: 'Pizza Place', category: 'Food'),
    ...
    testWidgets('should show snackbar when add button is tapped with no selections', (WidgetTester tester) async {
      // Arrange
      final testSpots = [
        WidgetTestHelpers.createTestSpot(id: 'spot-1', name: 'Coffee Shop', category: 'Cafe'),
      ];
    ...
    testWidgets('should display empty state when no spots match search', (WidgetTester tester) async {
      // Arrange
      final testSpots = [
        WidgetTestHelpers.createTestSpot(id: 'spot-1', name: 'Coffee Shop', category: 'Cafe'),
      ];
      ...
      expect(find.text('No spots found matching "nonexistentspot"'), findsOneWidget);
    ...
    testWidgets('should display empty state when no spots are available', (WidgetTester tester) async {
      ...
      expect(find.text('Create spots first to add them to lists'), findsOneWidget);
      expect(find.byIcon(Icons.location_off), findsOneWidget);
    });

    testWidgets('should display loading state while spots are loading', (WidgetTester tester) async {
    ...
    testWidgets('should display error state and retry button when spots fail to load', (WidgetTester tester) async {
