...
import 'package:spots/core/models/dynamic_knot.dart';
...
class _KnotMeditationPageState extends State<KnotMeditationPage> {
  ...
  Future<void> _graduallyRelaxKnot() async {
    ...
    for (int i = 0; i < steps; i++) {
      ...
      setState(() {
        _currentStressLevel = (_currentStressLevel - stressReduction).clamp(0.0, 1.0);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Knot Meditation'),
        actions: [
          if (_isMeditating)
            IconButton(
