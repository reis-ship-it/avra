...
import 'package:spots_network/network/ble_message_sender_impl_stub.dart'
    if (dart.library.io) 'package:spots_network/network/ble_message_sender_impl_io.dart'
    if (dart.library.html) 'package:spots_network/network/ble_message_sender_impl_web.dart'
    as impl;
