...
import 'package:spots_network/network/ble_gatt_stream_fetcher_impl_stub.dart'
    if (dart.library.io) 'package:spots_network/network/ble_gatt_stream_fetcher_impl_io.dart'
    if (dart.library.html) 'package:spots_network/network/ble_gatt_stream_fetcher_impl_web.dart'
    as impl;
