...
Float64List calculateAlexanderPolynomial({required List<double> braidData}) =>
    RustLib.instance.api.crateApiCalculateAlexanderPolynomial(
      braidData: braidData,
    );
...
double calculateTopologicalCompatibility({
  ...
  braidDataA: braidDataA,
  braidDataB: braidDataB,
);
...
BigInt calculateCrossingNumberFromBraid({required List<double> braidData}) =>
    RustLib.instance.api.crateApiCalculateCrossingNumberFromBraid(
      braidData: braidData,
    );
...
double evaluatePolynomial({
  ...
  required double x,
}) => RustLib.instance.api.crateApiEvaluatePolynomial(
...
double calculateKnotEnergyFromPoints({required List<double> knotPoints}) =>
    RustLib.instance.api.crateApiCalculateKnotEnergyFromPoints(
...
double calculateKnotStabilityFromPoints({required List<double> knotPoints}) =>
    RustLib.instance.api.crateApiCalculateKnotStabilityFromPoints(
      knotPoints: knotPoints,
    );
...
class KnotResult {
  ...
  final int writhe;
  final int signature;
  final BigInt? unknottingNumber;
  final BigInt bridgeNumber;
  final BigInt braidIndex;
  final int determinant;
  final int? arfInvariant;
  final double? hyperbolicVolume;
  final Float64List? homflyPolynomial;
  ...
  int get hashCode =>
      ...
      writhe.hashCode ^
      signature.hashCode ^
      unknottingNumber.hashCode ^
      bridgeNumber.hashCode ^
      braidIndex.hashCode ^
      determinant.hashCode ^
      arfInvariant.hashCode ^
      hyperbolicVolume.hashCode ^
      homflyPolynomial.hashCode;
