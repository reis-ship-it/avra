...
import 'package:spots_knot/models/knot/knot_worldsheet.dart';
...
class KnotWorldsheetService {
  ...
  // TODO: Use _fabricService for on-the-fly fabric generation
  // ignore: unused_field
  ...
  Future<KnotWorldsheet?> createWorldsheet({
    ...
    try {
      ...
      // Step 2: Get initial fabric
      final initialFabric = await _storageService.loadFabric(groupId);
      if (initialFabric == null) {
        developer.log(
          'No initial fabric found, cannot create worldsheet',
          name: _logName,
        );
        return null;
      }
