...
```
[Copy AGENT 1 section from docs/AGENT_TASK_ASSIGNMENTS.md]
...
```
[Copy AGENT 2 section from docs/AGENT_TASK_ASSIGNMENTS.md]
...
```
[Copy AGENT 3 section from docs/AGENT_TASK_ASSIGNMENTS.md]
