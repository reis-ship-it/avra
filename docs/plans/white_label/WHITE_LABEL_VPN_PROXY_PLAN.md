...
┌─────────────────────────────────────────────────────────┐
│                 SPOTS Main Instance                      │
│  (api.spots.app - User's personal account)              │
└─────────────────────────────────────────────────────────┘
                         ↕ Federation Protocol
┌─────────────────────────────────────────────────────────┐
│            White-Label Instance A                        │
│  (branded.spots.app - Partner branded)                  │
│  → Routes through VPN/Proxy if configured               │
└─────────────────────────────────────────────────────────┘
                         ↕ Federation Protocol
┌─────────────────────────────────────────────────────────┐
│            White-Label Instance B                        │
│  (another-partner.spots.app)                            │
└─────────────────────────────────────────────────────────┘
```
...
```json
{
  ...
  "baseUrl": "https://partner.spots.app",
  "federationEndpoint": "https://api.spots.app/api/federation",
  "branding": {
    "logo": "https://partner.spots.app/logo.png",
    "colors": { ... },
