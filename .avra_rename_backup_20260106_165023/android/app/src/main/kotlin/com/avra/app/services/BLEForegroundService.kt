package com.spots.app.services
...
class BLEForegroundService : Service() {
  ...
  companion object {
    ...
    const val ACTION_START = "com.spots.app.services.action.START"
    const val ACTION_STOP = "com.spots.app.services.action.STOP"
    const val ACTION_UPDATE_SCAN_INTERVAL = "com.spots.app.services.action.UPDATE_SCAN_INTERVAL"
    const val ACTION_START_PERIPHERAL = "com.spots.app.services.action.START_PERIPHERAL"
    const val ACTION_STOP_PERIPHERAL = "com.spots.app.services.action.STOP_PERIPHERAL"
    const val ACTION_SET_PERIPHERAL_PAYLOAD = "com.spots.app.services.action.SET_PERIPHERAL_PAYLOAD" // legacy alias
    const val ACTION_SET_VIBE_PAYLOAD = "com.spots.app.services.action.SET_VIBE_PAYLOAD"
    const val ACTION_SET_PREKEY_PAYLOAD = "com.spots.app.services.action.SET_PREKEY_PAYLOAD"
    const val ACTION_SET_SERVICE_DATA_FRAME_V1 =
      "com.spots.app.services.action.SET_SERVICE_DATA_FRAME_V1"
