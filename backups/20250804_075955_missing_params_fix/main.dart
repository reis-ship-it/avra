...
import 'package:spots/data/datasources/local/sembast/sembast/sembast_seeder.dart';
  ...
  try {
    if (kIsWeb) {
      ...
      try {
        ...
        developer.log('🔍 Main: Found ${records.length} demo users in database');
        for (final record in records) {
          developer.log('🔍 Main: Demo user record: ${record.value}');
        }
      } catch (e) {
        developer.log('🔍 Main: Error checking demo user: $e');
      }
    }
