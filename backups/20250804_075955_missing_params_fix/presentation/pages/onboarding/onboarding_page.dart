...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  void _completeOnboarding() async {
    try {
      developer.log('🎯 Completing Onboarding:');
      developer.log('  Homebase: $_selectedHomebase');
      developer.log('  Favorite Places: $_favoritePlaces');
      developer.log('  Preferences: $_preferences');
          ...
          builder: (context) => AILoadingPage(
            ...
            onLoadingComplete: () async {
              try {
                ...
                developer.log('✅ Onboarding completed, navigating to home');
              } catch (e) {
                developer.log('Error in onboarding completion: $e');
              }
            },
          ),
        ),
