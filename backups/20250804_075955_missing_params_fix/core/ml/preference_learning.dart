...
class PreferenceLearningEngine {
  ...
  Future<Map<String, double>> _analyzeCategoryPreferences(UserBehaviorData data) async {
    return {'food': 0.8, 'entertainment': 0.6};
  }
  
  Future<Map<String, double>> _analyzeTimePreferences(UserBehaviorData data) async {
    return {'morning': 0.3, 'afternoon': 0.4, 'evening': 0.8};
  }
  
  Future<Map<String, double>> _analyzeSocialPreferences(UserBehaviorData data) async {
