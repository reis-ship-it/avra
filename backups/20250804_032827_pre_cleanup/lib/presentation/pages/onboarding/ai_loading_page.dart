  ...
  void _startLoading() async {
    ...
    try {
      ...
      if (homebase == null || homebase.isEmpty) {
        homebase = "New York";
        print('⚠️ Using fallback homebase: $homebase');
      }
      if (favoritePlaces.isEmpty) {
        ...
        print('⚠️ Using fallback favorite places: $favoritePlaces');
      }
      if (preferences.isEmpty) {
        ...
        print('⚠️ Using fallback preferences: $preferences');
      }

      // Generate personalized lists using AI
      print('🔄 Generating AI lists...');
      ...
      print('✅ Generated ${generatedLists.length} lists: $generatedLists');
      ...
      if (mounted && generatedLists.isNotEmpty) {
        ...
        for (final listName in generatedLists) {
          ...
          print('📝 Creating list: ${newList.title}');
      ...
      print('Error generating lists: $e');
    }
