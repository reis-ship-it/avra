  ...
  Future<User?> signIn(String email, String password) async {
    try {
      ...
      if (isOnline && remoteDataSource != null) {
        print('🔐 AuthRepository: Trying remote sign in');
        final user = await remoteDataSource!.signIn(email, password);
        if (user != null) {
          print('🔐 AuthRepository: Remote sign in successful');
      ...
      print('🔐 AuthRepository: Trying local sign in');
      print('🔐 AuthRepository: localDataSource is ${localDataSource == null ? 'null' : 'not null'}');
      final localUser = await localDataSource?.signIn(email, password);
      print('🔐 AuthRepository: Local sign in result: ${localUser?.email ?? 'null'}');
      return localUser;
    } catch (e) {
      print('🔐 AuthRepository: Sign in error: $e');
