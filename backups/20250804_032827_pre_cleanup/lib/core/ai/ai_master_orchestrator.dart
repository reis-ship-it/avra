...
import 'package:spots/core/ai/personality_learning.dart' show UserPersonality;
...
class AIMasterOrchestrator {
  ...
  Future<void> initialize() async {
    try {
      ...
      _personalityLearning = PersonalityLearning(prefs: prefs);
  ...
  Future<void> _coordinatePersonalityLearning(ComprehensiveData data) async {
    try {
      ...
      final evolvedPersonality = await _personalityLearning.evolvePersonality(
          _convertToPatternRecognitionUserActionData(userAction));
  ...
  List<UnifiedUserAction> _extractUserActions(ComprehensiveData data) {
    return data.userActions.map((actionData) => UnifiedUserActionData(
  ...
  pattern_recognition.UserAction _convertToPatternRecognitionUserActionData(UnifiedUserAction unifiedAction) {
    return pattern_recognition.UserActionData(
