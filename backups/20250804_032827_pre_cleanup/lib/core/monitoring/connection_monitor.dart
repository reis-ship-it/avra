...
class ConnectionMonitor {
  ...
  Future<ConnectionStatus> getConnectionStatus(String connectionId) async {
    try {
      final session = _monitoringSessions[connectionId];
      if (session == null) {
        return ConnectionStatus.notFound(connectionId);
      }
      ...
      return ConnectionStatus.error(connectionId, e.toString());
    }
  }
...
class ConnectionStatus {
  ...
  static ConnectionStatus notFound(String connectionId) {
    return ConnectionStatus(
      connectionId: connectionId,
  ...
  static ConnectionStatus error(String connectionId, String error) {
    return ConnectionStatus(
      connectionId: connectionId,
      currentPerformance: CurrentPerformanceMetrics.zero(),
      healthScore: 0.0,
